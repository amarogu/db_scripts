...
-- Feira
INSERT INTO Feira (nome, data_inicio, data_fim, local, cidade, descricao) VALUES
('Feira do Livro de Braga 2026', '2026-05-01', '2026-05-15', 'Parque da Ponte', 'Braga', 'Edicao anual da Feira do Livro de Braga'),
('Feira do Livro do Porto 2026', '2026-06-01', '2026-06-20', 'Parque da Cidade', 'Porto', 'Edicao anual da Feira do Livro do Porto'),
...
-- Livro
INSERT INTO Livro (ISBN, titulo, ano_publicacao, genero, preco, id_editora) VALUES
...
-- Stand
INSERT INTO Stand (numero, nome_comercial, area_m2, localizacao, id_feira, id_editora) VALUES
...
-- BarracaComida
INSERT INTO BarracaComida (numero, nome_comercial, tipo_culinaria, id_feira) VALUES
...
-- Apresentacao
INSERT INTO Apresentacao (titulo, sala, data_hora, duracao_min, lotacao_max, estado_tempo, estado_vagas, id_feira, id_livro, id_autor) VALUES
...
-- SessaoAutografos
INSERT INTO SessaoAutografos (data_hora, duracao_min, localizacao, lotacao_max, estado_tempo, estado_vagas, id_feira, id_autor) VALUES
...
-- Inscreve_Feira
INSERT INTO Inscreve_Feira (data_inscricao, tipo_bilhete, preco, estado, id_visitante, id_feira) VALUES
...
INSERT INTO Inscreve_Apresentacao (data_inscricao, estado, id_visitante, id_apresentacao) VALUES
...
-- Inscreve_Sessao
INSERT INTO Inscreve_Sessao (data_inscricao, estado, id_visitante, id_sessao) VALUES
('2026-04-20', 'ativa', 1, 1),
('2026-04-21', 'ativa', 2, 1),
...
-- gere
INSERT INTO gere (id_administrador, id_feira, data_inicio_gestao, cargo) VALUES
